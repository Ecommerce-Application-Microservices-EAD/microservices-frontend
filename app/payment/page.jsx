    ...
    if (totalAmount > 0) {
      const fetchClientSecret = async () => {
        try {
          ...
          const response = await axios.post('http://127.0.0.1:8085/api/payments/create', {
  ...
  return (
    <div className="payment-page">
      ...
      <div className="container">
        {!showCheckout ? (
          <>
            <Cart onTotalAmountChange={handleTotalAmount} />
            <button
          ...
          clientSecret && paymentId && (
            <div className="checkout-section">
              <Elements stripe={stripePromise} options={{ clientSecret }}>
                <CheckoutForm totalAmount={totalAmount} paymentId={paymentId} />
              </Elements>
              <button
