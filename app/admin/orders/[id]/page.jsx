  ...
  const handleChangeStatus = async (newStatus) => {
    ...
    try {
      ...
      const response = await axiosInstance.put(
        `/orders/${order.orderId}/status?status=${newStatus}`,
        {},
        {
          headers: {
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          <div className="mb-4">
            <table className="min-w-full bg-gray-700 rounded-lg">
              <tbody>
                <tr>
                  <td className="py-2 px-4 border-b border-gray-600 text-gray-300 font-semibold">
                    Total Amount:
                  </td>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-gray-700 rounded-lg">
              <thead>
                <tr>
                  <th className="py-2 px-4 border-b border-gray-600 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider">
                    Product ID
                  </th>
                  <th className="py-2 px-4 border-b border-gray-600 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider">
                    Name
